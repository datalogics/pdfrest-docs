---
title: Introduction
description: Setting up an instance of PDF to Office Pro Self-Hosted API
icon: ""
...
[PDF to Office Pro Self-Hosted API](https://aws.amazon.com/marketplace/pp/prodview-gilhkmjyjxyrs) can be found in the AWS Marketplace.

## Prerequisites

Please start by subscribing to [PDF to Office Pro Self-Hosted API](https://aws.amazon.com/marketplace/pp/prodview-gilhkmjyjxyrs) in the AWS Marketplace then select your preferred delivery method below to begin the setup process.

## CloudFormation Template

Follow this documentation if you're using the pdfRest to Office Pro Self-Hosted API along with our CloudFormation Template. :br
...
::button-link
---
to: /pdf-to-office-pro-self-hosted/amazon-machine-image/launching-an-ec2-instance
---
