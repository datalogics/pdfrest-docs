...
Microsoft Core Fonts are not licensed to be distributed with pdfRest Self-Hosted API products but they are freely and easily accessible for you to install.

MS Core fonts are optional when deploying a pdfRest Self-Hosted API. They enable the following features:
