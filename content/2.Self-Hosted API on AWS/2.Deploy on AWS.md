---
title: Deploy on AWS
description: Learn how to set up and deploy your pdfRest Self-Hosted API on AWS.
meta_title: pdfRest Self-Hosted API on AWS | Deploy on AWS
meta_description: Learn how to set up and deploy your pdfRest Self-Hosted API on AWS.
---
